...
AgenteIA::AgenteIA()
    : margenError(14.0f), nivelDificultad(1), sesgoAngulo(0.0f), sesgoFuerza(0.0f)
{
}
...
Decision AgenteIA::razonar(const Percepcion &percepcion)
{
    ...
    return Decision{300.0f + sesgoFuerza, anguloBase + sesgoAngulo};
}
...
void AgenteIA::registrarResultado(float fuerza, float angulo, float distanciaFinal)
{
    historial.push_back(Lanzamiento{fuerza, angulo, distanciaFinal});
    calcularCorreccion();
}
