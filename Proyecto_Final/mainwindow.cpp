...
void MainWindow::configurarEscena()
{
    ...
    // Que los botones no roben el foco del teclado, para que las flechas
    // y el espacio siempre lleguen al juego
    ui->botonCambiarNivel->setFocusPolicy(Qt::NoFocus);
    ui->botonReiniciar->setFocusPolicy(Qt::NoFocus);
